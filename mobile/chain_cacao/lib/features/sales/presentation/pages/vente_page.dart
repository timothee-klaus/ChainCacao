...
class VentePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('VENTE & TRANSFERT', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800, letterSpacing: 1.2)),
        backgroundColor: Colors.white,
        elevation: 0,
        centerTitle: true,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  lotsAsync.when(
                    data: (lots) => _buildLotSelection(ref, lots, transferState),
                    loading: () => const Center(child: CircularProgressIndicator(color: Color(0xFF2D1E17))),
  ...
  Widget _buildLotSelection(WidgetRef ref, List<CacaoLot> lots, TransferFormState state) {
    if (lots.isEmpty) {
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected ? const Color(0xFF2D1E17) : Colors.grey[200]!,
                ),
              ...
              child: Column(
                ...
                children: [
                  Icon(
                    lot.species.toLowerCase().contains('cacao') ? Icons.eco : Icons.coffee,
                  ...
                  Text(
                    '${lot.weightKg} KG',
                    style: TextStyle(
                      color: isSelected ? Colors.white : const Color(0xFF2D1E17),
                      fontSize: 14,
                      fontWeight: FontWeight.w900,
                    ),
                  ),
  ...
  Widget _buildSummaryItem(String label, String value) {
    return Column(
      ...
      children: [
        ...
        Text(
          value,
          style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w900, color: Color(0xFF2D1E17)),
        ),
      ],
    );
  }
