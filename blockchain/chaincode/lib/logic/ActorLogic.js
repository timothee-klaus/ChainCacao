...
class ActorLogic {
    ...
    async registerActor(actorIdHash, typeActeur, clePublique, callerId, metadata = '{}') {
        ...
        const actor = Schemas.createActor(actorIdHash, typeActeur, clePublique, timestamp, callerId, metadataObj);
